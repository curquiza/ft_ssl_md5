...
INPUT_CMDS = [
    ...
    { 'cmd': './ft_ssl md5 README.md src src/main.c',                       'error': True,  'output': 'md5_err_2' },
    { 'cmd': './ft_ssl md5 sha256 src src/main.c',                          'error': True,  'output': 'md5_err_3' },
    ...
    { 'cmd': 'echo bouh | ./ft_ssl sha256 -ppppp src/main.c README.md',     'error': False, 'output': 'sha256_opt_p_1' },
    { 'cmd': 'echo bouh | ./ft_ssl sha256 src/main.c',                      'error': False, 'output': 'sha256_stdin_1' },
    { 'cmd': 'echo bouh | ./ft_ssl sha256 src/main.c -p',                   'error': True,  'output': 'sha256_stdin_2' },
