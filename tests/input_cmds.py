...
INPUT_CMDS = [
    ...
    # { 'cmd': 'echo -n bouh | ./ft_ssl sha256 -ppppp ft_ssl README.md',      'error': False,  'output': 'sha256_opt_p_1' },
    ...
    # { 'cmd': './ft_ssl sha512 -rrrrr README.md',                            'error': True,   'output': 'sha512_opt_qr_1' },
    # { 'cmd': './ft_ssl sha512 -rrrqrr README.md',                           'error': True,   'output': 'sha512_opt_qr_2' },
